...
//        semi.depositAccount(100_000,"YEN"); // 예외 발생 (지원하지 않는 통화 입금(출금도 동일))
//        semi.depositAccount(100_000,"DOLOR"); // 예외 발생 (계좌의 허용 통화와 다른 통화 입금(출금도 동일))
...
//        semi.checkAccountBalance(nhnBank);
        ...
        //[수정] Bank한테 넘기기
        nhnBank.deposit(semi, 100_000, "WON");
        nhnBank.withdrawal(semi,50_000,"WON");
        nhnBank.printAccountBalance(semi);
        ...
        nhnBank.printAccountBalance(soo);
        //예외 발생(- 음수 돈으로 계좌 생성)
