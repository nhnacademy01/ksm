...
class GameServer {
    ...
    class ClientSession extends Thread {
        ...
        private void joinGame(ClientSession clientSession) {
            ...
            sender.sendToAllExceptOne("[System] 용사 " + clientSession.id
                + "님이 입장했습니다.", clientSession.out);

            System.out.println(getTime() + " " + clientSession.id + " is joined: "
                + clientSession.socket.getInetAddress());
        ...
        private void leaveGame(ClientSession clientSession) {
            ...
            System.out.println(getTime() + " " + clientSession.id + " is leaved: "
                + clientSession.socket.getInetAddress());
            loggingCurrentClientCount();
        }
        ...
        private void loggingCurrentClientCount() {
            System.out.println(getTime() + " Currently " + clientOutMap.size()
